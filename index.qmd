...
-   **Route Omission**
    ...
    -   Since there are zero attempts for both Route 3 and Route 4, we
        have ommitted these from the analysis because there is no activity. This
        shows that these are not viable routes for expedition.
